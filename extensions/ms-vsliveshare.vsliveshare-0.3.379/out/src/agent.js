    ...
    static dependencyCheck() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                child_process.exec('dpkg --list libssl1.0.? | grep "^ii"', (err, stdout, stderr) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
                    ...
                    if (libSslInstances.length === 1 || (amd64Count <= 1 && i386Count <= 1 && otherCount <= 1 && amd64Count + i386Count + otherCount >= 1)) {
                        ...
                        const result = yield vscode_1.window.showErrorMessage('VS Live Share has failed to start because multiple sub-versions of libssl1.0 are installed. Remove one of these sub-versions and try again.', moreInfo);
                        if (result === moreInfo) {
