...
class Client {
    ...
    _onDidChangeTextDocument(e) {
        ...
        if (changeDidntMakeDocumentDirty) {
            this.postSaveMessageToOtherParticipents(fileClient.fileName);
        }
    ...
    _onDidSaveTextDocument(e) {
        ...
        this.postSaveMessageToOtherParticipents(fileName);
    }
    postSaveMessageToOtherParticipents(fileName) {
    ...
    pin(editor, clientId) {
        ...
        this.jumpTo(clientId, viewColumn);
    }
