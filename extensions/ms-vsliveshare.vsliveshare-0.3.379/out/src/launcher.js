...
class Launcher {
     ...
     */
    static readCascadeURL() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const jsonFileContents = yield Launcher.readFileContents(Launcher.cascadeLaunchUrlFile);
                const launchUrlFileModificationTime = yield util.getModificationTime(Launcher.cascadeLaunchUrlFile);
                const fileAge = util.getTimestampAge(launchUrlFileModificationTime);
                yield Launcher.safelyDeleteCascadeUrlFile();
    ...
    static safelyDeleteCascadeUrlFile() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (Launcher.isAppTranslocated && (config.get(config.Key.showLauncherError) || userInitiated)) {
                    ...
                    const success = yield Launcher.run(userInitiated, installInitiated); /* registers the protocol handler */
                ...
                if (os.platform() === util_1.OSPlatform.LINUX && e === 127) {
                    yield util_1.ExtensionUtil.promptLinuxDependencyInstall('VS Live Share could not complete launcher installation due to missing dependencies.');
                }
