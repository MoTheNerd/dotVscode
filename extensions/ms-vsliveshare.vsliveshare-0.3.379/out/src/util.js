...
})(ShowInStatusBarOption = exports.ShowInStatusBarOption || (exports.ShowInStatusBarOption = {}));
...
class ExtensionUtil {
    static InitLogging() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.logFileTraceListener.openAsync();
    ...
    static setDiagnosticLogging(focus = false) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    static getErrorString(code) {
        return ExtensionUtil.getString('error.' + VSLS_1.ErrorCodes[code]);
    }
    ...
    static runWithProgress(fn, progressOptions = userProgressOptionsDefaults) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!isUserInitiated) {
                ...
                options.title = '';
                // await ExtensionUtil.checkifAgentHanged();
            }
    ...
    static shouldStatusBarItemBeVisible(userInitiated = false) {
