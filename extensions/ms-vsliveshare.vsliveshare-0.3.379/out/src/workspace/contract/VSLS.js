...
exports.FileService = {
    name: 'file',
    methods: ['listRoots', 'list', 'readText', 'readStream', 'writeText', 'writeStream', 'createDirectory', 'delete', 'copy', 'move', 'getFiles', 'isExcluded'],
    events: ['filesChanged'],
};
...
exports.TerminalService = {
    name: 'terminal',
    methods: ['startTerminal', 'getRunningTerminals', 'resizeTerminal', 'stopTerminal'],
    events: ['terminalStarted', 'terminalResized', 'terminalStopped'],
};
...
exports.WorkspaceUserService = {
    name: 'workspaceuser',
    methods: ['acceptOrRejectGuest', 'removeUser', 'fireProgressUpdatedToGuest', 'getCountOfGuestsWithSameAccount'],
...
exports.DebuggerHostService = {
    ...
    methods: ['getCurrentDebugSessions'],
    events: ['debugSessionChanged'],
};
