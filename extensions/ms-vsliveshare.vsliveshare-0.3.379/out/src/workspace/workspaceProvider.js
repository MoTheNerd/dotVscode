...
class DeprecatedWorkspaceProvider {
    ...
    write(resource, content) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const exists = yield this.fileExists(resource);
                if (exists) {
                ...
                const writeResult = yield this.fileService.writeTextAsync(resource.path, stringContent, { append: false, createIfNotExist: true });
    ...
    mkdir(resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let createResult = yield this.fileService.createDirectoryAsync(resource.path);
