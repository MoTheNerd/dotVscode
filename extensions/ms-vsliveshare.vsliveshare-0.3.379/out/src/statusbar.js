    ...
    updateStatusBar(newState) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.disposed) {
                ...
                if (util_1.ExtensionUtil.shouldStatusBarItemBeVisible()) {
...
class CollaborationState extends SignedInState {
    ...
    innerUpdateCollabStatusBarItem(collaboratorsItem, textOnly) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((state !== session_1.SessionState.Joined && state !== session_1.SessionState.Shared) || !util_1.ExtensionUtil.shouldStatusBarItemBeVisible()) {
                return;
            }
