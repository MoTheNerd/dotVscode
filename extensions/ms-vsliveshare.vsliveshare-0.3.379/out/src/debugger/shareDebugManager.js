...
class ShareDebugManager {
    ...
    registerDebuggerHostService(add) {
        return __awaiter(this, void 0, void 0, function* () {
            // register myself as the IDebuggerHostService contract
            yield this.rpcClient.sendRequest(this.trace, 'workspace.registerServices', null, [VSLS_1.DebuggerHostService.name], add ? 'Add' : 'Remove');
        });
    }
...
ShareDebugManager.unsupportedDebugTypes = ['extensionHost'];
