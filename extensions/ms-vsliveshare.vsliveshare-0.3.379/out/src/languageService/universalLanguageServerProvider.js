...
class UniversalLanguageServerProvider {
    ...
    initAsync() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.workspaceService.registerServicesAsync([UniversalLanguageServerProvider.SERVICE_NAME], VSLS_1.WorkspaceServicesChangeType.Add);
    ...
    dispose() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.workspaceService.registerServicesAsync([UniversalLanguageServerProvider.SERVICE_NAME], VSLS_1.WorkspaceServicesChangeType.Remove);
