...
class AzureParentNode extends AzureNode_1.AzureNode {
    ...
    loadMoreChildren() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const newTreeItems = yield this.treeItem.loadMoreChildren(this, clearCache);
    ...
    pickChildNode(expectedContextValues) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const options = {
                placeHolder: localize_1.localize('selectNode', 'Select a {0}', this.treeItem.childTypeLabel)
            };
