        ...
        try {
            ...
            if (!context.suppressErrorDisplay) {
                ...
                if (errorData.message.includes('\n')) {
                    ...
                    result = yield vscode_1.window.showErrorMessage(localize_1.localize('multilineError', 'An error has occured. Check output window for more details.'), DialogResponses_1.DialogResponses.reportAnIssue);
                }
                else {
                    result = yield vscode_1.window.showErrorMessage(errorData.message, DialogResponses_1.DialogResponses.reportAnIssue);
                }
