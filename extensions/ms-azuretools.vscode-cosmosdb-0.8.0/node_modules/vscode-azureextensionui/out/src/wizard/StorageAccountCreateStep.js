    ...
    execute(wizardContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!wizardContext.storageAccount) {
                ...
                extensionVariables_1.ext.outputChannel.appendLine(localize_1.localize('CreatingStorageAccount', 'Creating storage account "{0}" in location "{1}" with sku "{2}"...', newName, newLocation, newSkuName));
                const storageClient = new StorageManagementClient(wizardContext.credentials, wizardContext.subscriptionId);
                ...
                extensionVariables_1.ext.outputChannel.appendLine(localize_1.localize('CreatedStorageAccount', 'Successfully created storage account "{0}".', newName));
            }
