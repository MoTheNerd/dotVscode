    ...
    execute(wizardContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!wizardContext.resourceGroup) {
                ...
                extensionVariables_1.ext.outputChannel.appendLine(localize_1.localize('CreatingResourceGroup', 'Ensuring resource group "{0}" in location "{1} exists"...', newName, newLocation));
                ...
                extensionVariables_1.ext.outputChannel.appendLine(localize_1.localize('CreatedResourceGroup', 'Successfully found resource group "{0}".', newName));
            }
