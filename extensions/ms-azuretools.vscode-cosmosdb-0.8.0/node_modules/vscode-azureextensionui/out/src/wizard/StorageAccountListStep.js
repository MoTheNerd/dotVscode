...
const extensionUserAgent_1 = require("../extensionUserAgent");
    ...
    prompt(wizardContext) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!wizardContext.storageAccount && !wizardContext.newStorageAccountName) {
                const client = new StorageManagementClient(wizardContext.credentials, wizardContext.subscriptionId);
                extensionUserAgent_1.addExtensionUserAgent(client);
