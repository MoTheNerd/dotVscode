...
class MongoDatabaseTreeItem {
    constructor(databaseName, connectionString, isEmulator, parentId) {
    ...
    createShell(shellPath) {
        return __awaiter(this, void 0, void 0, function* () {
            return shell_1.Shell.create(shellPath, this.connectionString, this.isEmulator)
                .then(shell => {
...
function withProgress(promise, title) {
