...
![Cosmos DB Extension](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/features.png)
...
![Browse CosmosDB and MongoDB databases](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/Browse.png)
...
![Mongo Scrapbook](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/Scrapbook.gif)

## Use [Gremlin](https://docs.microsoft.com/azure/cosmos-db/gremlin-support) to query graphs

![Query Graphs](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/Graph.gif)
...
![Create Cosmos DB Account](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/create.gif)
...
![Attach Emulator](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/attachEmulator.png)

## Managing Azure Subscriptions

If you are not signed in to Azure, you will see a "Sign in to Azure..." link. Alternatively, you can select "View->Command Palette" in the VS Code menu, and search for "Azure: Sign In".

![Sign in to Azure](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/SignIn.gif)
...
![Select Azure Subscriptions](https://github.com/microsoft/vscode-cosmosdb/raw/master/resources/SelectSubscriptions.gif)
...
## Code of Conduct
This project has adopted the [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). For more information see the [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) or contact [opencode@microsoft.com](https://github.com/microsoft/vscode-cosmosdb/blob/master/mailto:opencode@microsoft.com) with any additional questions or comments.

# Telemetry
VS Code collects usage data and sends it to Microsoft to help improve our products and services. Read our [privacy statement](https://go.microsoft.com/fwlink/?LinkID=528096&clcid=0x409) to learn more. If you don’t wish to send usage data to Microsoft, you can set the `telemetry.enableTelemetry` setting to `false`. Learn more in our [FAQ](https://code.visualstudio.com/docs/supporting/faq#_how-to-disable-telemetry-reporting).

# License
[MIT](https://github.com/microsoft/vscode-cosmosdb/blob/master/LICENSE.md)
