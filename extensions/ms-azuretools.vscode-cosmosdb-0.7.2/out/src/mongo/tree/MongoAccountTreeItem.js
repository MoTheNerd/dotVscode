    ...
    loadMoreChildren(node, _clearCache) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                db = yield mongodb_1.MongoClient.connect(this.connectionString);
                ...
                return databases
                    ...
                    .map(database => new MongoDatabaseTreeItem_1.MongoDatabaseTreeItem(database.name, this.connectionString, node.id));
            }
            catch (error) {
                return [{
                        id: 'cosmosMongoError',
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (databaseName) {
                ...
                if (collectionName) {
                    ...
                    const databaseTreeItem = new MongoDatabaseTreeItem_1.MongoDatabaseTreeItem(databaseName, this.connectionString, node.id);
