...
class GraphViewServer extends events_1.EventEmitter {
    ...
    getViewSettings() {
        var viewSettings = vscode.workspace.getConfiguration().get('cosmosDB.graph.viewSettings') || {};
        return viewSettings;
    }
    queryAndShowResults(queryId, gremlinQuery) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield vscode_azureextensionui_1.callWithTelemetryAndErrorHandling("cosmosDB.gremlinQuery", telemetry_1.reporter, undefined, function () {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        var fullResults = yield thisServer.executeQuery(queryId, gremlinQuery);
                        ...
                        if (results.limitedVertices.length) {
                            try {
                                ...
                                var edges = yield thisServer.queryEdges(queryId, results.limitedVertices);
    ...
    handleQueryMessage(queryId, gremlin) {
    ...
    setUpSocket() {
        ...
        this._socket.onClientMessage('query', (queryId, gremlin) => this.handleQueryMessage(queryId, gremlin));
